...
export default class Popularcourses extends Component {
    render() {
        return (
         <div>
  <i><h1  style={{textAlign: "center" ,color: "black" ,margin:"0%" ,marginBottom: "20px"}}>POPULAR ONLINE COURSES</h1></i>
...
<a href="/video">
<button className="btn btn-primary" style={{marginLeft: "48%" ,marginTop: "10px",display: "block" , borderRadius: "14px" ,backgroundColor: "rgb(0, 47, 255)" ,padding: "10px" ,color: "white" ,fontWeight: "800" ,marginTop:"20px"}}>View All Courses</button></a>
         </div>
        );
    }
}
