...
<div className="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
        ...
        <div className="carousel-inner">
          <div  className="carousel-item active">
            ...
            <img    className="d-block w-100 " id="img1" src="./images/test6.jfif" />
            <img  className="d-block w-100 " id="img2" src="./images/test.jfif" />
            </a>
          ...
          <div className="carousel-item">
            ...
            {/* <p alt="..." className="d-block w-100" style={{background: "rgb(7, 0, 122)",background: "linear-gradient( 210deg, rgba(7, 0, 122, 1) 2%, rgba(8, 8, 134, 1) 35%, rgba(0, 145, 175, 1) 100% )"}}></p> */}
             ...
             <p className="animated bounceInLeft d-none d-md-block" style={{animationDelay: "2s"}}></p>
              <p className="animated bounceInRight" style={{animationDelay:"3s"}}><a href="#">Learn More</a></p> */}
               <a href="https://youtube.com/playlist?list=PL3uv3qBos9qsclt6A6vyq0TNd26m91gcC">
            <img    className="d-block w-100 " id="img1" src="./images/c1.jfif" />
            <img  className="d-block w-100 " id="img2" src="./images/c2.jfif" />
            </a>
            </div>
...
<a href="/tutions">
            <img    className="d-block w-100 " id="img1" src="./images/c4.jfif" />
            <img  className="d-block w-100 " id="img2" src="./images/c3.jfif" />
            </a>
