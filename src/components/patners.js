          ...
          <div className="row features_row">
            ...
            <div className="col-lg-4 feature_col">
              <div className="feature text-center trans_400">
                ...
                <div className="feature_text">
                 <i> <p style={{fontStyle:"italic"}}>We are partnered with various companies like Schemax,  Antar IOT, OBSELE for providing paid internships.</p></i>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 feature_col">
              <div className="feature text-center trans_400">
                ...
                <div className="feature_text">
                <i >  <p style={{fontStyle:"italic"}}>All our workshop attendees are Contented with our content.</p></i>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 feature_col">
              <div className="feature text-center trans_400">
                ...
                <div className="feature_text">
                 <i> <p style={{fontStyle:"italic"}}>Guest webinars with industrial experts from ISRO, ANC security, IIM and IIT alumnis and Andhra university.</p></i>
                </div>
              </div>
            </div>
          </div>
